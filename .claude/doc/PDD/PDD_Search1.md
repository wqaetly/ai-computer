...
force_auth_duo_id	BOOLEAN	非必填	是否使用工具商专属推广计划，默认为false
...
请求示例: https://gw-api.pinduoduo.com/api/router?type=pdd.ddk.oauth.goods.search&data_type=JSON&client_id=8de7a099abc743348a31184daed8fc96&access_token=44b763d20422472f802fdf3ec84b6f2134127550&pid=43592911_311190797&timestamp=1760669360&sign=6A849889E239E75614F22D6D7D9350CB
点击收起
JAVA
CURL
1
curl -X POST 'http://gw-api.pinduoduo.com/api/router' \
2
...
-d pid=str \
7
-d type=pdd.ddk.oauth.goods.search \
8
